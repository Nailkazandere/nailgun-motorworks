    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-black/90 backdrop-blur-md border-b border-gray-800" : "bg-black/70 backdrop-blur-sm"}`}>
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <button onClick={() => router.push("/services")} className="text-xs text-gray-400 hover:text-white uppercase tracking-widest transition-colors">{nav[0]}</button>
          <button onClick={() => router.push("/about")} className="text-xs text-gray-400 hover:text-white uppercase tracking-widest transition-colors">{nav[1]}</button>
          <button onClick={() => router.push("/contact")} className="text-xs text-gray-400 hover:text-white uppercase tracking-widest transition-colors">{nav[2]}</button>
      ...
      {menuOpen && (
        <div className="md:hidden bg-black/95 border-t border-gray-800 px-6 py-4 flex flex-col gap-4">
          <button onClick={() => { router.push("/services"); setMenuOpen(false); }} className="text-sm text-gray-400 hover:text-white uppercase tracking-widest text-left transition-colors">{nav[0]}</button>
          <button onClick={() => { router.push("/about"); setMenuOpen(false); }} className="text-sm text-gray-400 hover:text-white uppercase tracking-widest text-left transition-colors">{nav[1]}</button>
          <button onClick={() => { router.push("/contact"); setMenuOpen(false); }} className="text-sm text-gray-400 hover:text-white uppercase tracking-widest text-left transition-colors">{nav[2]}</button>
        </div>
      )}
    </nav>
  );
